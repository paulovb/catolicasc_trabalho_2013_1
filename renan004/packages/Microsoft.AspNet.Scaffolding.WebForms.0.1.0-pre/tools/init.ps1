...
function GetLoadedScaffoldingAssemblyVersion() {
	try {
		return [Microsoft.AspNet.Scaffolding.WebForms.Scaffolders].Assembly.GetName().Version
	} catch {
		return $null
	}
}
...
if ($ScaffoldingAssemblyVersion -eq $null)
{
	...
	$dllsToLoad = ("Microsoft.AspNet.Scaffolding.EntityFramework.dll","Microsoft.AspNet.Scaffolding.WebForms.dll")
	foreach($dllFile in $dllsToLoad)
	{
		$dllPath = Join-Path $installPath "scaffolders"
		$dllPath = Join-Path $dllPath $dllFile
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU49jffxIlGkpCxNJW/EdAnVLC
# LCWgghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# BBTeAtpFZwbUs563cDTwfOR9jUWSAzBmBgorBgEEAYI3AgEMMVgwVqA8gDoATQBp
...
# AABw2onzCczBxEg97HBXku+Ej19vpcfngOyPy+j7yQ1jy1oUeq857nG2W3G1ybfH
# AbdHljrX/DlNLBU205IVCCnYR5YaTB39XooSUuk+454TlqjMGklhBc5c6xxN9EhR
# YaISgjEX651HVeFwVccOLv+vlD3CVLeej3oxdSzIgRtM0P+WTgYQVnx1dIUUCQ9T
# qwkXjPoo3E4M9mAnVm2XbVYaVMvA93YyJtVoD+JvTLoJ11qBBeaDBYs4bAUQhsTi
# TcLDcecFy8RcuTWBzIR73c8NIbd8D1crHxu2rxs77CRKLrm8yqhUjU+3iPnw7W6k
# IGLLQxY/346dQCVhzIEuncyhggIfMIICGwYJKoZIhvcNAQkGMYICDDCCAggCAQEw
...
# MzAyMTUyMDU2MjZaMCMGCSqGSIb3DQEJBDEWBBTDW0mK3+5BY0p2Y5iqWZPU3OAW
# cDANBgkqhkiG9w0BAQUFAASCAQCjJyLxEAIXPa9yfRoJwdMGZC/VuHfpxZfZqWAU
# 3cd3aI5CQ7nCG/da3j/SbpNz6ilL9haXVBT565EWxTCg3KI7JAKKyBZfiTmpt6tn
# y6wLdXX/GBt6lvwnJE6BDljK5RT58tLAzG6gd4QBMcioXTa2b8hZHQcERavTiTJ7
# P7whmgceRaAnxPfpOBVooW+EsXHo5dhUQ/u9m/TCcFCs6eeLW4JwNjpjD/ASEvWt
# Zs1qBA/u0ExV4V8Y1rJOcd3MyOOBTbhzq3b9h3Py6enEzkVjw4P4DHGQE3BFgSPC
# zgbi1C+HpcIvXC1un9HEyZkUsuuUJ16cs/ClJt8OiOwMHn9T
